  ...
  return (
    <div className={classes.introcontainer}>
        ...
        <p className={classes.intro}>
          ...
          <br />I worked on various web design and development tasks, below you can find some of my past work. Click on individual card to learn more (the cards will collapse into fewer column(s) on narrow screens).
        </p>
